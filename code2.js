...
if($(window).width() > 1000){
  if(jQuery('.racao').data('clicked')) {																	
    ...
    $("#imgBox6").css({"margin-left": "40px","margin-top":"50px","max-width": "1050px","width":"170px","max-height": "450px","height":"170px","padding":"20px","box-shadow": "0 0 1px"});
    ...
    $("#imgBox8").css({"margin-left": "50px","margin-top":"50px","max-width": "1050px","width":"150px","max-height": "450px","height":"150px","padding":"20px","box-shadow": "0 0 1px"});
    ...
    $("#10").css({"margin-top": "-600px" });
    $("h3").css({"opacity": "0", });
    $("p1").css({"opacity": "0", });
    $("h5").css({"margin-left": "100px","width":"420px","margin-top": "-180px","font-size":"30px", });
    $("h6").css({"width":"30px","margin-top": "-130px","font-size":"35px","margin-right": "0px" });
  ...
  if(jQuery('.casa').data('clicked')) {																	
              ...
              $("#boxtext8").css({"margin-left": "80px","margin-top": "-60px", });
              $(".casa").css({"width": "550px", "height": "600px","margin-left": "60px","cursor": "auto"});
              $("#imgBox9").css({"margin-left": "50px","margin-top":"50px","max-width": "1050px","width":"150px","max-height": "450px","height":"160px","padding":"20px","box-shadow": "0 0 1px"});
              $("#boxtext9").css({"margin-left": "80px","margin-top": "-60px", });   
              $(".p2").css({"opacity": "1","width":"420px","margin-left": "-40px","margin-top": "-20px" });
              $("#camaText").css({"margin-top": "-20px" });
              $("h3").css({"opacity": "0", });
              $("p1").css({"opacity": "0", });
              $("h5").css({"margin-left": "100px","width":"420px","margin-top": "-180px","font-size":"30px", });
              $("h6").css({"width":"30px","margin-top": "-130px","font-size":"35px","margin-right": "0px" });
              $(".imgwpBox").css({"opacity": "1","margin-left": "180px","margin-top": "-300px", }); $("h6").css({"width":"30px","margin-top": "-130px","font-size":"35px","margin-right": "0px" });
              $('.racao').hide();
              $('.camaCasa').hide();
              $('.arranhador').hide();
              $('.roupa').hide();
